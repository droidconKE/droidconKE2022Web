    ...
    <div className="w-full flex items-start flex-col">
      <div className="pt-4 md:pt-6">
        <img
          ...
          src={`https://via.placeholder.com/150/${isDarkTheme ? '000000' : 'E2E8F0'}?text=droidconKe`}
          alt="session"
        />
      </div>
      {/* <h4 className="pt-2 h-4 w-20 bg-gray-200 skeleton">&nbsp;</h4> */}
      <p className="pt-2 h-4 mt-2 w-40 bg-gray-300 dark:bg-black-dark animate-pulse skeleton">&nbsp;</p>
      <p className="pt-2 h-4 mt-2 w-56 bg-gray-300 dark:bg-black-dark animate-pulse skeleton">&nbsp;</p>
